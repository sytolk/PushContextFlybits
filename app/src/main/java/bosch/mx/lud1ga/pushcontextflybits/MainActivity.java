...
//                        requestMoments(false);
    ...
    private void requestZones(final boolean subscribed){
        ...
        Flybits.include(MainActivity.this).getZones(null,
...
//                        Log.i(TAG, "onSuccess -- getZoneMoments -- l:"+ pagination.limit+" ... t:"+pagination.totalRecords);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                if (bundle.containsKey("CONTEXT_TYPE")) {
                    ...
                    if (bundle.getString("CONTEXT_TYPE").equals(AvailablePlugins.LOCATION.getKey())) {
                        LocationData data = bundle.getParcelable("CONTEXT_OBJ");
                        Toast.makeText(MainActivity.this, "Location Plugin :: " + data.toString()
                                , Toast.LENGTH_SHORT).show();
//                        Log.i(TAG, "Location Plugin :: " + data.toJson());
                    ...
                    if (bundle.getString("CONTEXT_TYPE").equals(AvailablePlugins.NETWORK_CONNECTIVITY.getKey())) {
                        NetworkData data = bundle.getParcelable("CONTEXT_OBJ");
                        Toast.makeText(MainActivity.this, "Network Plugin :: " + data.ssid
                                , Toast.LENGTH_SHORT).show();
